  ...
  return (
    <div className="min-h-screen bg-[#121212] pb-24">
      ...
      <div className="relative">
        ...
        <div className="relative z-10 px-4 sm:px-6 lg:px-8 pt-12 pb-8 max-w-7xl mx-auto">
          {/* Navigation */}
          ...
          >
            <div className="flex items-end gap-6">
              <div className="w-48 h-48 bg-gradient-to-br from-green-500 to-green-700 rounded-lg shadow-2xl flex items-center justify-center">
                <BookOpen className="w-24 h-24 text-white" />
              </div>
              <div className="flex-1">
                <p className="text-sm text-gray-300 mb-2">PLAYLIST</p>
                <h1 className="text-6xl font-bold text-white mb-4">Academic Courses</h1>
                <p className="text-gray-300 mb-4">Comprehensive academic courses and specialized training programs</p>
          ...
          >
            <Button
              size="lg"
              className="bg-green-500 hover:bg-green-600 text-black font-bold rounded-full px-8 py-3 text-lg"
              onClick={() => setIsPlaying(!isPlaying)}
            >
              <Play className="w-6 h-6 mr-2" />
              {isPlaying ? 'Pause' : 'Play'}
            </Button>
            <Button variant="ghost" size="icon" className="w-12 h-12 text-white hover:bg-white/10 rounded-full">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-10 bg-[#181818] border-gray-600 text-white placeholder-gray-400"
            />
          </div>
        ...
        <div className="bg-[#181818] rounded-lg overflow-hidden">
          ...
          {filteredCourses.map((course, index) => (
            <motion.div
              ...
              className="grid grid-cols-12 gap-4 px-4 py-3 hover:bg-[#282828] group cursor-pointer"
            >
          ...
          {courses.slice(0, 6).map((course, index) => (
            ...
            >
              <div className="relative mb-3">
                ...
                <Button
                  size="icon"
                  className="absolute bottom-2 right-2 w-12 h-12 bg-green-500 hover:bg-green-600 text-black rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0"
                >
      ...
      {/* Bottom Player - Fixed */}
      <div className="fixed bottom-0 left-0 right-0 bg-[#181818] border-t border-gray-700 p-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white font-medium">Academic Courses</p>

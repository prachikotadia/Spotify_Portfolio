    ...
    <div className="fixed bottom-0 left-0 right-0 bg-black border-t border-gray-800 z-40 safe-area-pb">
      ...
      <div className="block md:hidden">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          {/* Center Spotify Logo - Overlapping */}
          <Link to="/">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <div className="w-12 h-12 -mt-4 bg-green-500 rounded-full flex items-center justify-center shadow-lg">
      ...
      <div className="hidden md:flex items-center justify-between px-6 py-3">
        ...
        <Link to="/">
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <div className="w-16 h-16 -mt-6 bg-green-500 rounded-full flex items-center justify-center shadow-xl">
